...
@WebFilter(filterName = "LotteryCrossOriginResourceSharingFilter", urlPatterns = { "/*" })
public class LotteryCORSFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(LotteryCORSFilter.class);
